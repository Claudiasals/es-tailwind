const App = () => {
  return (
    <main className="bg-white min-h-screen flex flex-col items-center justify-start p-8 font-brand text-brand-blue">
     ...
     ESERCIZI 7 e 8
      ...
      <div className="flex flex-wrap justify-center gap-6 mb-12">
        ...
        <div className="bg-[#A7C7E7] border-t-4 border-brand-purple rounded-lg shadow-lg p-6 w-72 flex flex-col items-center">
          ...
          <p className="mb-4 text-brand-blue text-center">Paragrafo  1</p>
          <button className="px-6 py-2 bg-brand-yellow text-white rounded-lg hover:bg-brand-purple transition-colors">
            Pulsante
          </button>
        </div>
        ...
        <div className="bg-[#FFD8A7] border-t-4 border-brand-purple rounded-lg shadow-lg p-6 w-72 flex flex-col items-center">
          ...
          <p className="mb-4 text-brand-blue text-center">Paragrafo  2</p>
          <button className="px-6 py-2 bg-brand-yellow text-white rounded-lg hover:bg-brand-purple transition-colors">
            Pulsante
          </button>
        </div>
        ...
        <div className="bg-[#FFF5A7] border-t-4 border-brand-purple rounded-lg shadow-lg p-6 w-72 flex flex-col items-center">
          ...
          <p className="mb-4 text-brand-blue text-center">Paragrafo  3</p>
          <button className="px-6 py-2 bg-brand-yellow text-white rounded-lg hover:bg-brand-purple transition-colors">
            Pulsante
          </button>
        </div>
      ...
      <div className="bg-white w-full max-w-5xl p-16 rounded-2xl shadow-lg text-brand-blue text-center">
